...
public class WavAudioRecorder {
    public final static int[] sampleRates = {44100, 22050, 11025};
    private static AudioDataReceivedListener mListener;
    public WavAudioRecorder(AudioDataReceivedListener listener) {
        mListener = listener;
    }
...
//            mListener.onAudioDataReceived((short)result);
    ...
    private AudioRecord.OnRecordPositionUpdateListener updateListener = new AudioRecord.OnRecordPositionUpdateListener() {
        ...
        public void onPeriodicNotification(AudioRecord recorder) {
            if (State.STOPPED == state) {
             ...
             numOfBytes = audioRecorder.read(buffer, 0, buffer.length); // read audio data to buffer
